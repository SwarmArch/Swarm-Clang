...
public:
  ...
  void DiagnoseSwarmSpawn(Stmt *S);

  StmtResult ActOnSwarmSpawnStmt(SourceLocation SpawnLoc,
                                 Stmt *InitStmt,
                                 ConditionResult Cond,
                                 Stmt *S,
                                 bool isSub, bool isSuper);

  // For non-timestamped spawns
  StmtResult ActOnSwarmSpawnStmt(SourceLocation SpawnLoc, Stmt *S);

  //TODO(victory): Declare all the SwarmFor-related functions/methods.
