...
enum CXCursorKind {
  ...
  /** \brief A _Swarm_spawn statement.
   */
  CXCursor_SwarmSpawnStmt = CXCursor_CilkForStmt + 1,

  /** \brief A _Swarm_for statement.
   */
  CXCursor_SwarmForStmt = CXCursor_SwarmSpawnStmt + 1,

  CXCursor_LastStmt = CXCursor_SwarmForStmt,
