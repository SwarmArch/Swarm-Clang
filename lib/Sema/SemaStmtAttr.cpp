...
static Attr *handleLoopHintAttr(Sema &S, Stmt *St, const AttributeList &A,
  ...
  if (PragmaNoUnroll) {
    ...
    Option = llvm::StringSwitch<LoopHintAttr::OptionType>(
                 ...
                 .Case("swarmify", LoopHintAttr::Swarmify)
                 .Case("expand", LoopHintAttr::Expand)
                 .Case("coarsen_factor", LoopHintAttr::CoarsenFactor)
                 .Default(LoopHintAttr::Vectorize);
    if (Option == LoopHintAttr::VectorizeWidth ||
        Option == LoopHintAttr::InterleaveCount ||
        Option == LoopHintAttr::UnrollCount ||
        Option == LoopHintAttr::CoarsenFactor) {
      ...
      State = LoopHintAttr::Numeric;
               ...
               Option == LoopHintAttr::Swarmify ||
               Option == LoopHintAttr::Expand) {
...
CheckForIncompatibleAttributes(Sema &S,
  ...
  for (const auto *I : Attrs) {
    ...
    enum { Vectorize, Interleave, Unroll, Distribute, Swarmify, Expand, Coarsen } Category;
    switch (Option) {
