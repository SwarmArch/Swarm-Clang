...
static void ProcessDeclAttribute(Sema &S, Scope *scope, Decl *D,
  ...
  case AttributeList::AT_XRayLogArgs:
    ...
    break;
  // Swarm attributes
  case AttributeList::AT_Swarmify:
    handleSimpleAttribute<SwarmifyAttr>(S, D, Attr);
    break;
  case AttributeList::AT_NoSwarmify:
    handleSimpleAttribute<NoSwarmifyAttr>(S, D, Attr);
    break;
  case AttributeList::AT_AssertSwarmified:
    handleSimpleAttribute<AssertSwarmifiedAttr>(S, D, Attr);
    break;
  }
}
