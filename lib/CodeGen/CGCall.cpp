...
void CodeGenModule::ConstructAttributeList(
  ...
  if (TargetDecl) {
    ...
    if (TargetDecl->hasAttr<SwarmifyAttr>())
      FuncAttrs.addAttribute("Swarmify");
    if (TargetDecl->hasAttr<NoSwarmifyAttr>())
      FuncAttrs.addAttribute("NoSwarmify");
    if (TargetDecl->hasAttr<AssertSwarmifiedAttr>())
      FuncAttrs.addAttribute("AssertSwarmified");
  }
