...
public:
  ...
  public:
    ...
    void StartDetach(bool isSwarm=false,
                     llvm::Value *Timestamp=nullptr,
                     bool isSubdomain=false,
                     bool isSuperdomain=false);
    void FinishDetach(bool isSwarm=false);
  ...
  void PopDetachScope(bool isSwarm=false) {
    CurDetachScope->FinishDetach(isSwarm);
...
public:
  ...
  /// expression and return an integer value of the specified width.
  llvm::Value *EvaluateExprAsInt(const Expr *E, const unsigned width);
  ...
  void EmitSwarmSpawnStmt(const SwarmSpawnStmt &S);
  //TODO(victory):
  //void EmitSwarmForStmt(const CilkForStmt &S,
  //                      ArrayRef<const Attr *> Attrs = None);
