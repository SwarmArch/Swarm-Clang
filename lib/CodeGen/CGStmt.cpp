...
#include "clang/AST/StmtNodes.inc"
  ...
  case Stmt::SwarmSpawnStmtClass:
                              EmitSwarmSpawnStmt(cast<SwarmSpawnStmt>(*S)); break;
  //TODO(victory): case Stmt::SwarmForStmtClass:
                              //TODO(victory): EmitSwarmForStmt(cast<SwarmForStmt>(*S)); break;
...
void CodeGenFunction::EmitAttributedStmt(const AttributedStmt &S) {
  ...
  case Stmt::CilkForStmtClass:
    ...
    break;
  //TODO(victory): case Stmt::SwarmForStmtClass:
    //TODO(victory): EmitSwarmForStmt(cast<SwarmForStmt>(*SubStmt), S.getAttrs());
    break;
  default:
    EmitStmt(SubStmt);
  }
