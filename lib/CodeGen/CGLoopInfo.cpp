...
static MDNode *createMetadata(LLVMContext &Ctx, const LoopAttributes &Attrs,
  ...
  if (!Attrs.IsParallel && Attrs.VectorizeWidth == 0 &&
      ...
      Attrs.SwarmifyEnable == LoopAttributes::Unspecified &&
      Attrs.ExpandEnable == LoopAttributes::Unspecified &&
      Attrs.CoarsenFactor == 0 &&
      !StartLoc && !EndLoc)
    return nullptr;
  ...
  // TODO(mcj) should we add a swarm.loop.spawn.strategy?
  // For now we'll just commandeer the tapir strategy
  ...
  // Setting swarmify.enable
  if (Attrs.SwarmifyEnable != LoopAttributes::Unspecified) {
    Metadata *Vals[] = {MDString::get(Ctx, "llvm.loop.swarmify.enable"),
                        ConstantAsMetadata::get(ConstantInt::get(
                            Type::getInt1Ty(Ctx), (Attrs.SwarmifyEnable ==
                                                   LoopAttributes::Enable)))};
    Args.push_back(MDNode::get(Ctx, Vals));
  }

  // Setting expand.enable
  if (Attrs.ExpandEnable != LoopAttributes::Unspecified) {
    Metadata *Vals[] = {MDString::get(Ctx, "llvm.loop.expand.enable"),
                        ConstantAsMetadata::get(ConstantInt::get(
                            Type::getInt1Ty(Ctx), (Attrs.ExpandEnable ==
                                                   LoopAttributes::Enable)))};
    Args.push_back(MDNode::get(Ctx, Vals));
  }

  // Setting coarsen.factor
  if (Attrs.CoarsenFactor > 0) {
    Metadata *Vals[] = {MDString::get(Ctx, "llvm.loop.coarsen.factor"),
                        ConstantAsMetadata::get(ConstantInt::get(
                            Type::getInt32Ty(Ctx), Attrs.CoarsenFactor))};
    Args.push_back(MDNode::get(Ctx, Vals));
  }
...
LoopAttributes::LoopAttributes(bool IsParallel)
    : IsParallel(IsParallel), VectorizeEnable(LoopAttributes::Unspecified),
      ...
      SwarmifyEnable(LoopAttributes::Unspecified),
      ExpandEnable(LoopAttributes::Unspecified),
      CoarsenFactor(0) {}
  ...
  for (const auto *Attr : Attrs) {
    ...
    case LoopHintAttr::Disable:
      ...
      case LoopHintAttr::Distribute:
        ...
        break;
      case LoopHintAttr::Swarmify:
        setSwarmifyEnable(false);
        break;
      case LoopHintAttr::Expand:
        setExpandEnable(false);
        break;
      case LoopHintAttr::UnrollCount:
      case LoopHintAttr::VectorizeWidth:
      case LoopHintAttr::InterleaveCount:
      case LoopHintAttr::CoarsenFactor:
